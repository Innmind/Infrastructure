...
final class SublimeText implements Gene
{
        ...
        try {
            $download = new Script(
                Command::foreground('curl')
                    ->withShortOption('o')
                    ->withArgument('sublimetext.dmg')
                    ->withShortOption('L')
                    ->withShortOption('C')
                    ->withArgument('-')
                    ->withArgument("https://download.sublimetext.com/Sublime Text Build {$this->version}.dmg")
            ...
            $install = new Script(
                Command::foreground('cp')
                    ...
                    ->withArgument('/Volumes/Sublime Text/Sublime Text.app')
                    ->withArgument('/Applications/'),
                Command::foreground('diskutil')
                    ->withArgument('unmountDisk')
                    ->withArgument('/Volumes/Sublime Text'),
